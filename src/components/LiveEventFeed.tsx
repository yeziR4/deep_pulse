  ...
  return (
    <section className="frost-panel p-4 font-mono">
      <div className="mb-4 flex items-center justify-between">
        ...
        <span className="bg-cyan-300/10 px-3 py-1 text-[10px] uppercase tracking-[0.16em] text-cyan-100">
          {pool}
        </span>
      </div>

      {lastMatch ? (
        <div className="bg-slate-950/70 p-4 shadow-inner">
        ...
        <div className="bg-cyan-300/10 p-4 text-blue-100/75 shadow-inner">
